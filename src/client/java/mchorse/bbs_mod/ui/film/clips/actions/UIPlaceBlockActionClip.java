...
public class UIPlaceBlockActionClip extends UIActionClip<PlaceBlockActionClip>
{
    ...
    protected void registerUI()
    {
        ...
        this.drop = this.toggle(UIKeys.ACTIONS_BLOCK_DROP, this.clip.drop);
        this.blockState = this.bind(
            new UIBlockStateEditor((state) -> this.editor.editMultiple(this.clip.state, (x) -> x.set(state))),

...
public class FilmStencilPicker
{
    ...
    public void renderPreview(UIContext context, Area area)
    {
        ...
        /* TODO(1.21.11 render): RenderSystem.depthFunc() was removed by the GPU-pipeline rewrite; this state is now encoded by the RenderLayer/RenderPipeline. */

        /* Cache the global stuff */
        MatrixStackUtils.cacheMatrices();

        /* TODO(1.21.11 render): RenderSystem.setProjectionMatrix() was removed by the GPU-pipeline rewrite; this state is now encoded by the RenderLayer/RenderPipeline. */

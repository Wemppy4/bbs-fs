...
{
    MANUAL("manual", UIKeys.FORMS_CATEGORIES_SORT_MANUAL, null),
    NAME("name", UIKeys.FORMS_CATEGORIES_SORT_NAME, Comparator.comparing((Form f) -> f.getDisplayName().toLowerCase())),
    TYPE("type", UIKeys.FORMS_CATEGORIES_SORT_TYPE, Comparator.comparing(Form::getFormId).thenComparing((Form f) -> f.getDisplayName().toLowerCase()));
    ...
    FormSort(String id, IKey label, Comparator<Form> comparator)
    {
        this.id = id;
        this.label = label;

    ...
    protected void renderCube(BufferBuilder builder, MatrixStack stack, ModelGroup group, ModelCube cube)
    {
        ...
        for (ModelQuad quad : cube.quads)
        {
            ...
            else
            {
                 ...
                 * index pattern (0,1,2, 2,3,0) — same two triangles, same winding. A triangle rides
                 * through as a quad with its last corner doubled. */
                ...
                this.writeVertex(builder, stack, group, quad.vertices.get(Math.min(3, count - 1)));
            }
        }

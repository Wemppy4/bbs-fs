...
public abstract class BaseFilmController
{
    ...
    public void render(WorldRenderContext context)
    {
        ...
        List<Replay> replays = this.replays();
        /* TODO(1.21.11 render): the 1.21.11 Fabric WorldRenderContext no longer hands out the frustum
         * (its interface is commandQueue/matrices/consumers only), so per-replay frustum culling is off
         * on this branch. The port already intercepts WorldRenderer#setupFrustum in WorldRendererMixin —
         * publishing that frustum is what this needs to come back. */
